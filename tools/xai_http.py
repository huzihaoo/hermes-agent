...
def get_env_value(name: str, default=None):
    ...
    Import ``hermes_cli.config.get_env_value`` at call time instead of caching
    it at module import.  Some tests and runtime bootstrap paths temporarily
    patch/reload config helpers; late binding prevents this module from
    freezing a stale helper and then missing dotenv-only credentials.
    """
    try:
